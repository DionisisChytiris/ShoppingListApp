...
import AddEditItemButtons from '../components/AddEditItemButtons';
      ...
      >
        ...
        >
          <Pressable
            ...
            style={{ width: '100%' }}
          >
            <View style={[styles.modalContent, { backgroundColor: theme.colors.surface, width: '100%', minHeight: editingItem? 400: 360}]}>
              <SafeAreaView edges={['bottom']} style={styles.safeArea}>
                {/* Handle bar */}
                <Pressable onPress={handleClose} style={{ height: 40 }}>
                  <View style={[styles.handleBar, { backgroundColor: theme.colors.outline }]} />
                  <View style={{ paddingLeft: '10%' }}>
                    <Ionicons name="close-circle" size={24} color={theme.colors.onSurfaceVariant} />
                  </View>
